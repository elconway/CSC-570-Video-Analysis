...
def main():
    ...
    # I have the application secret saved outside the git repo
    your_app_client_id = 'dMLPgtBrFXZpQwjsEnuTTJfUrXiUqSrCzgQcVQZ1'
    with open("../../emotiv.secret", "r") as file:
        your_app_client_secret = file.read().strip()
